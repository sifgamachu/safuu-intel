    ...
    <div style={{background:"#030507",minHeight:"100vh",fontFamily:"'Space Grotesk',sans-serif",color:"rgba(240,236,224,0.9)"}}>
      ...
      <nav style={{borderBottom:`1px solid rgba(0,212,255,0.1)`,padding:"0 32px",display:"flex",alignItems:"center",justifyContent:"space-between",height:"60px",background:"rgba(3,5,7,0.97)",backdropFilter:"blur(16px)",position:"sticky",top:0,zIndex:100}}>
        <a href="/" style={{display:"flex",alignItems:"center",gap:"12px"}}>
          ...
          <div><div style={{fontSize:"16px",fontWeight:"900",color:"rgba(240,236,224,0.95)",fontFamily:"serif"}}>SAFUU</div><div style={{fontSize:"7px",color:CY,letterSpacing:"0.3em",fontFamily:"'Courier New',monospace",opacity:0.6}}>SOOMAALI</div></div>
        </a>
        <div style={{display:"flex",gap:"14px",alignItems:"center"}}>
          <a href="/" style={{fontSize:"10px",color:`rgba(0,212,255,0.5)`,fontFamily:"'Courier New',monospace"}}>English</a>
          <a href="/am" style={{fontSize:"10px",color:`rgba(0,212,255,0.5)`,fontFamily:"'Courier New',monospace"}}>አማርኛ</a>
          <a href="/report" style={{background:G,color:"#030507",fontFamily:"'Courier New',monospace",fontSize:"10px",fontWeight:"700",padding:"8px 18px",letterSpacing:"0.12em"}}>Soo Gudbi ⚖</a>
        </div>
      </nav>
      <section style={{minHeight:"85vh",display:"flex",flexDirection:"column",justifyContent:"center",padding:"72px 32px",animation:"fadeUp 0.8s ease-out"}}>
        <div style={{maxWidth:"800px",margin:"0 auto",width:"100%"}}>
          <div style={{display:"flex",alignItems:"center",gap:"12px",marginBottom:"28px"}}>
            ...
            <span style={{fontSize:"9px",color:R,fontFamily:"'Courier New',monospace",letterSpacing:"0.2em",fontWeight:"700"}}>ITOOBIYA · 2026 · SAFUU.NET</span>
            <div style={{flex:1,height:"1px",background:"rgba(184,32,32,0.2)"}}/>
          </div>
          <h1 style={{fontSize:"clamp(40px,8vw,80px)",fontWeight:"900",fontFamily:"serif",lineHeight:1.1,marginBottom:"24px"}}>
            <span style={{display:"block",color:"rgba(240,236,224,0.95)"}}>Musuqmaasuqa</span>
            <span style={{display:"block",color:G,fontStyle:"italic"}}>Soo Gudbi</span>
          </h1>
          <p style={{fontSize:"16px",color:"rgba(240,236,224,0.5)",lineHeight:"1.9",marginBottom:"12px",maxWidth:"560px"}}>
            Aqoonsigaagu <strong style={{color:G}}>gabi ahaanba waa la ilaaliyaa</strong>. SHA-256 hash keliya — looma kicin karo.
          </p>
          <p style={{fontSize:"14px",color:"rgba(240,236,224,0.4)",lineHeight:"1.9",marginBottom:"40px",maxWidth:"560px"}}>
            Warbixinta AI waxay xaqiijisaa oo u soo diraysaa FEACC, Booliiska Federaalka, ama hay'ad kale.
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:"12px",marginBottom:"40px"}}>
            {[{icon:"📲",t:"Telegram",s:"Cod / Qoraal",href:"https://t.me/SafuuEthBot"},{icon:"📱",t:"SMS — 21000",s:"Telefoon kasta",href:"/sms"},{icon:"🌐",t:"Foomka Internetka",s:"Toos u soo gudbi",href:"/report"}].map((c,i)=>(
          ...
          <div style={{background:"rgba(0,0,0,0.5)",border:`1px solid rgba(0,212,255,0.1)`,padding:"20px 24px"}}>
            <div style={{fontSize:"9px",color:CY,fontFamily:"'Courier New',monospace",letterSpacing:"0.2em",marginBottom:"12px"}}>AMNIGA</div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:"14px",fontSize:"12px"}}>
              {[["🔐 Aqoonsi","SHA-256 — dib loo kicin karo"],["🔒 Sirta","AES-256-GCM — dhammaan qeybaheeda"],["⛓️ Cadeymo","Silsilad hash — maxkamad u diyaar"],["⚖️ Hay'adaha","FEACC 959 · Booliis 911"]].map(([k,v])=>(
      ...
      <div style={{borderTop:`1px solid rgba(0,212,255,0.08)`,padding:"20px 32px",background:"rgba(0,0,0,0.9)",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:"10px"}}>
        <span style={{fontSize:"9px",color:`rgba(0,212,255,0.2)`,fontFamily:"'Courier New',monospace"}}>SAFUU INTEL · FEACC: 959 · EHRC: 1488 · BOOLIIS: 911</span>
