    ...
    <div style={{background:"#030507",minHeight:"100vh",fontFamily:"'Space Grotesk',sans-serif",color:"rgba(240,236,224,0.9)"}}>
      ...
      <nav style={{borderBottom:`1px solid rgba(0,212,255,0.1)`,padding:"0 32px",display:"flex",alignItems:"center",justifyContent:"space-between",height:"60px",background:"rgba(3,5,7,0.97)",backdropFilter:"blur(16px)",position:"sticky",top:0,zIndex:100}}>
        <a href="/" style={{display:"flex",alignItems:"center",gap:"12px"}}>
          ...
          <div><div style={{fontSize:"16px",fontWeight:"900",color:"rgba(240,236,224,0.95)",fontFamily:"serif"}}>SAFUU</div><div style={{fontSize:"7px",color:CY,letterSpacing:"0.3em",fontFamily:"'Courier New',monospace",opacity:0.6}}>QAFAR</div></div>
        </a>
        <div style={{display:"flex",gap:"14px",alignItems:"center"}}>
          <a href="/" style={{fontSize:"10px",color:`rgba(0,212,255,0.5)`,fontFamily:"'Courier New',monospace"}}>English</a>
          <a href="/report" style={{background:G,color:"#030507",fontFamily:"'Courier New',monospace",fontSize:"10px",fontWeight:"700",padding:"8px 18px",letterSpacing:"0.12em"}}>Xabar Ti ⚖</a>
        </div>
      </nav>
      <section style={{minHeight:"85vh",display:"flex",flexDirection:"column",justifyContent:"center",padding:"72px 32px",animation:"fadeUp 0.8s ease-out"}}>
        <div style={{maxWidth:"800px",margin:"0 auto",width:"100%"}}>
          <div style={{display:"flex",alignItems:"center",gap:"12px",marginBottom:"28px"}}>
            ...
            <span style={{fontSize:"9px",color:R,fontFamily:"'Courier New',monospace",letterSpacing:"0.2em",fontWeight:"700"}}>ITIYOOPHIYA · 2026 · SAFUU.NET</span>
          ...
          <h1 style={{fontSize:"clamp(40px,8vw,80px)",fontWeight:"900",fontFamily:"serif",lineHeight:1.1,marginBottom:"24px"}}>
            <span style={{display:"block",color:"rgba(240,236,224,0.95)"}}>Qaraaxo</span>
            <span style={{display:"block",color:G,fontStyle:"italic"}}>Xabar Ti</span>
          </h1>
          <p style={{fontSize:"16px",color:"rgba(240,236,224,0.5)",lineHeight:"1.9",marginBottom:"12px",maxWidth:"560px"}}>
            Tuk-maqe <strong style={{color:G}}>gab mabde-kini</strong>. SHA-256 hash qoxtoh — ma-inni mabde-kini.
          </p>
          <p style={{fontSize:"14px",color:"rgba(240,236,224,0.4)",lineHeight:"1.9",marginBottom:"40px",maxWidth:"560px"}}>
            Xabar AI takke yaabis, FEACC, Federaalak Police, woo kayna organisation takke sageh.
            15 xabar yaabis gabo magacu dadkan sogot.
          </p>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:"12px",marginBottom:"40px"}}>
            {[{icon:"📲",t:"Telegram",s:"Caru / Dabi",href:"https://t.me/SafuuIntelBot"},{icon:"📱",t:"SMS — 21000",s:"Phone kata",href:"/sms"},{icon:"🌐",t:"Website Form",s:"Toktok xabar",href:"/report"}].map((c,i)=>(
              <a key={i} href={c.href} target={c.href.startsWith("http")?"_blank":"_self"} rel="noreferrer"
                style={{background:"rgba(0,0,0,0.5)",border:`1px solid rgba(201,168,76,0.15)`,padding:"22px",display:"block",textDecoration:"none",color:"inherit"}}>
          ...
          <div style={{background:"rgba(0,0,0,0.5)",border:`1px solid rgba(0,212,255,0.1)`,padding:"20px 24px"}}>
            <div style={{fontSize:"9px",color:CY,fontFamily:"'Courier New',monospace",letterSpacing:"0.2em",marginBottom:"12px"}}>AWBUUD</div>
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:"14px",fontSize:"12px"}}>
              {[["🔐 Tuk-maqe","SHA-256 — ma-inni"],["🔒 Kooktite","AES-256-GCM — gereb mabde"],["⛓️ Xujjah","Hash silsilah — mahkamah"],["⚖️ Hay'at","FEACC 959 · Police 911"]].map(([k,v])=>(
