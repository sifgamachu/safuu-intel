        ...
        <div style={{maxWidth:"1180px",margin:"0 auto"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:"24px",marginBottom:"24px"}}>
            ...
            <div style={{display:"flex",gap:"32px",flexWrap:"wrap"}}>
              {[["/transparency","Transparency Wall"],["/analytics","Analytics"],["/report","File a Report"],["/sms","SMS Guide"],["/about","About"],["/partners","Partners"],["/press","Press Kit"],["/privacy","Privacy Policy"],["https://github.com/sifgamachu/safuu-intel","GitHub"],["https://t.me/SafuuEthBot","Telegram"]].map(([h,l])=>(
