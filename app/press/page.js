...
const FACTS = [
  ...
  ["Channels","Telegram bot · SMS shortcode 21000 · Web form"],
      ...
      <div style={{maxWidth:"860px",margin:"0 auto",padding:"72px 40px 100px",animation:"fadeUp 0.8s ease-out"}}>
        ...
        <div style={{marginBottom:"56px"}}>
          ...
          <div style={{fontSize:"14px",color:"rgba(240,236,224,0.5)",lineHeight:"1.95"}}>
            <p style={{marginBottom:"16px"}}>Citizens file anonymous reports via Telegram, web form, or SMS (21000) in any of 11 Ethiopian languages. No identity is ever stored — only a one-way SHA-256 cryptographic hash, making identification mathematically impossible.</p>
        ...
        <div style={{background:"rgba(0,212,255,0.03)",border:`1px solid rgba(0,212,255,0.15)`,padding:"36px"}}>
          ...
          <p style={{fontSize:"13px",color:"rgba(240,236,224,0.45)",lineHeight:"1.85",marginBottom:"24px",maxWidth:"500px"}}>
            For interview requests, additional data, or coverage of specific cases on the transparency wall, contact us via Telegram. We respond to verified media organizations within 48 hours.
          </p>
