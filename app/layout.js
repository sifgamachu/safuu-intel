import { Playfair_Display, Space_Grotesk, Barlow_Condensed } from "next/font/google";
...
const barlow   = Barlow_Condensed({ subsets:["latin"], weight:["600","700","800","900"], style:["normal","italic"], variable:"--font-headline", display:"swap" });
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={`${playfair.variable} ${grotesk.variable} ${barlow.variable}`}>
      <head>
