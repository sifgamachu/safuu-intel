      ...
      <div style={{maxWidth:"800px",margin:"0 auto",padding:"80px 40px",animation:"fadeUp 0.8s ease-out"}}>
        ...
        <Section label="HOW ANONYMITY IS GUARANTEED" color={CY}>
          <div style={{display:"grid",gap:"20px"}}>
            {[
              {title:"No identity stored — ever", body:"SAFUU never records your Telegram username, user ID, phone number, or name. The moment a tip is received, only a one-way SHA-256 cryptographic hash is created — a mathematical fingerprint that cannot be reversed into your identity."},
              ...
              {title:"Sessions expire automatically", body:"Telegram conversation sessions expire after 30 minutes of inactivity. There is no persistent user record."},
